...
toString() | toSting(null) | --- | A string value | ```string.toString()```
valueOf() | valueOf(null) | --- | A string representing the primitive value of a given String object. | ```string.valueOf()```
